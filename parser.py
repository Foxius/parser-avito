...
# url = f"https://www.avito.ru/rossiya/zapchasti_i_aksessuary/zapchasti/dlya_avtomobiley/toyota-ASgBAgICA0QKJKwJ~GPGxw2UoUw?cd=1&f=ASgBAgECBEQKJKwJ~GPQtw3ShTPGxw2UoUwBRcaaDBd7ImZyb20iOjUwMDAsInRvIjo1NjAwfQ&user=1"
# r = session.request('GET', url)
# soup = bs(r.content, 'html.parser')
# print(soup)
# wb = openpyxl.open("mercedes.xlsx")
# wb.active = 0
# sheet = wb.active
for_table = []
for i in range(1, 26, 10):
    ...
    time.sleep(40)
    # a = input() #либо time.sleep(кол-во сек задержки)
export_csv = DataFrame(for_table).to_excel(r'6.xlsx', index=None, header=None)
